...
DROP INDEX public.expense_items_updated_at_idx;
DROP INDEX public.expense_items_created_at_idx;
DROP INDEX public.configs_path_idx;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_telegram_username_key;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_telegram_userid_key;
ALTER TABLE ONLY public.users DROP CONSTRAINT users_pkey;
ALTER TABLE ONLY public.expense_items DROP CONSTRAINT expense_items_pkey;
ALTER TABLE ONLY public.expense_category_recommendations DROP CONSTRAINT expense_category_recommendations_pkey;
...
ALTER TABLE public.expense_items ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.expense_category_recommendations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.expense_categories ALTER COLUMN id DROP DEFAULT;
ALTER TABLE public.configs ALTER COLUMN id DROP DEFAULT;
DROP TABLE public.users;
DROP SEQUENCE public.expense_items_id_seq;
DROP TABLE public.expense_items;
DROP SEQUENCE public.expense_category_recommendations_id_seq;
DROP TABLE public.expense_category_recommendations;
